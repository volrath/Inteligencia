...
public class NeuroticPacmanController implements PacController{
    public static final double MAXDIST = 39.5; 
    FullGame game;
    ...
    private Vector<Double> getInputs(FullGame game, MazeNode pacman_node) {
        ...
        if(verbose == 2) System.out.println("Posicion en x de Pacman: "+pacman_node.x+" div: "+((double)pacman_node.x/* / MAXDIST*/));
        inputs.add(new Double((double)pacman_node.y)/* / MAXDIST*/);
        if(verbose == 2) System.out.println("Posicion en y de Pacman: "+pacman_node.y+" div: "+((double)pacman_node.y/* / MAXDIST*/));
